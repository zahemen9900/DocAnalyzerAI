...
.action-button {
    ...
    padding: 0.8rem 1.5rem !important;  /* Increased padding for bigger buttons */
...
.action-button:hover {
    ...
    box-shadow: 0 4px 8px #000000 !important;
}
...
def create_demo():
    ...
    try:
        ...
        with gr.Blocks(css=CUSTOM_CSS, theme=gr.themes.Monochrome) as demo:
            ...
            with gr.Accordion("Example Questions", open=False, elem_classes="accordion-container"):
